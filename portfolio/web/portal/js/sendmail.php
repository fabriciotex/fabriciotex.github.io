...
$sendto = 'marketing2@interlakenturismo.com.br';

// The subject you'll see in your inbox
$subject = 'Perguntas sobre o Portal Uma So Interlaken';

// Message for the user when he/she doesn't fill in the form correctly.
$errormessage = 'Parece que faltou algo. Tente novamente.';

//Message for the user when he/she fills in the form correctly.
$thanks = "Obrigado por perguntar. Assim que possível responderemos.";

// Message for the bot when it fills in in at all.
$honeypot = "You filled in the honeypot! If you're human, try again!";

// Various messages displayed when the fields are empty.
$emptyname =  'Como você se chama mesmo?';
$emptyemail = 'Qual seu email mesmo?';
$emptymessage = 'Esqueceu sua pergunta?';

// Various messages displayed when the fields are incorrectly formatted.
$alertname =  'Digitou seu nome com o nosso alfabeto padrão?';
$alertemail = 'Digite seu email nesse formato: <i>nome@exemplo.com.br</i>';
$alertmessage = "Tenha certeza que não tem nenhum caractere estranho na mensagem. Ahh, a maioria dos links funciona bem!";
